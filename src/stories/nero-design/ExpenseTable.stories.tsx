                ...
                <td className="px-3 py-4 align-middle">
                  <div className="flex items-center gap-2">
                    <button onClick={() => onDeleteRow?.(row.id)}
                      ...
                      style={{ boxShadow: '0px 1px 3px 0px rgba(0,0,0,0.1), 0px 1px 2px 0px rgba(0,0,0,0.06)' }} title="Delete row">
                    ...
                    <button onClick={() => onCopyRow?.(row.id)}
                      className="flex items-center justify-center w-8 h-8 rounded-[8px] bg-white border border-[#e0e0e0] text-[#9e9e9e] hover:bg-[#f1528b] hover:border-[#f1528b] hover:text-white transition-colors"
                      style={{ boxShadow: '0px 1px 3px 0px rgba(0,0,0,0.1), 0px 1px 2px 0px rgba(0,0,0,0.06)' }} title="Duplicate row">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
